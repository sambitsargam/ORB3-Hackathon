  ...
  return (
    <>
      <div className="bg-gray-800">
        ...
        <Hero />
        <SectionTitle
          pretitle="MetaTinder Benefits"
          title=" Why should you use MetaTinder"
        ></SectionTitle>
        <Benefits data={benefitOne} />
        <Benefits imgPos="right" data={benefitTwo} />
        <SectionTitle pretitle="about" title="Learn more about MetaTinder">
          MetaTinder a decentralise storage online Platforms with NFT and
