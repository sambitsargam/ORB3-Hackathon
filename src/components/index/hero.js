      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            MetaTinder is your ultimate dating platform that fosters genuine connections. Alongside features like secure data storage, an NFT marketplace, and real-time chat capabilities, It's core essence lies in bringing people together to create lasting bonds of love and companionship.
