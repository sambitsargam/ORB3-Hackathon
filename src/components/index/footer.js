          ...
          <div className="lg:col-span-2">
            <div>
              ...
              <a className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                ...
                <span>MetaTinder</span>
              </a>
              {/* </Link> */}
            </div>

            <div className="max-w-md mt-4 text-gray-500 dark:text-gray-400">
  MetaTinder is an advanced dating platform that redefines online connections through its unique blend of decentralized storage, NFT integration, and chat capabilities. Users on MetaTinder can securely store their personal data using Web3 Storage, with data seamlessly linked through Spruce ID for enhanced security and privacy. This enables users to effortlessly access their files directly via web browsers, eliminating the need for third-party software.
  <br /><br />
