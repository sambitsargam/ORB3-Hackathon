...
const benefitTwo = {
  title: "And even more with MetaTinder...",
  image: benefitOneImg,
  bullets: [
    {
      title: "NFT Token",
      desc: "Mint NFT directly from files saved on MetaTinder ",
      icon: <DevicePhoneMobileIcon />,
    },
    {
      title: "Chat",
      desc: "Send messages with anyone you want using MetaTinder but you have to pay for it.",
